...
def batt_conversion(v0,v1,v2,v3,v4,v5,Name):
	...
	print(str(t) + '|' + str(Name) + '|||' + str(performance)+"|"+str(batt_percent)+"|"+str(PIR_Out)+"|"+str(reed)+"|"+str(light)+"|perf-batt-PIR-reed-light")
...
def main():
    ...
    parser.add_argument('-Na','--device_name', action='store')
